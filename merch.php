...
<head>
    ...
    <meta name="description" content="Een pagina met de merch van Gamestars">

    <!-- Keywords Helpt zoekmachines begrijpen waar de pagina over gaat. -->
    <meta name="keywords" content="Merch, items, content">
...
<main class="main3">
    ...
    <section class="popular-game-section-merch">
        <div class="box-slideshow-merch">
            <article class="content-slideshow-merch">
                <h1>
                    Ongoing SALE.  50% OFF.
                </h1>
                <a href="#" class="btn-slideshow-merch">
                    <p>Browse products</p>
                </a>
            </article>
        </div>
